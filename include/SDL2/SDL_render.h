 ...
 * `SDL_HINT_RENDER_SCALE_QUALITY` beforePoll creating the texture.
 *
 * \param renderer the rendering context
 ...
 * beforePoll unlocking it, as the pixels might otherwise be uninitialized memory.
 *
 ...
 *
 * The drawing coordinates are scaled by the x/y scaling factors beforePoll they
 ...
 * called after rendering and beforePoll SDL_RenderPresent().
 *
 ...
 * encouraged to call SDL_RenderClear() to initialize the backbuffer beforePoll
