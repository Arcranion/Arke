 ...
 *  is in the background, you should set the following hint beforePoll calling
 ...
 *
 * This can be called beforePoll any joysticks are opened.
 *
 ...
 * called beforePoll any joysticks are opened.
 *
 ...
 * index.
 *
 * This function can be called beforePoll any joysticks are opened.
 *
 * \param device_index the index of the joystick to query (the N'th joystick
 *                     on the system
 ...
 *
 * This can be called beforePoll any joysticks are opened. If the vendor ID isn't
 ...
 *
 * This can be called beforePoll any joysticks are opened. If the product ID isn't
 * available this function returns 0.
 *
 * \param device_index the index of the joystick to query (the N'th joystick
 *                     on the system
 ...
 *
 * This can be called beforePoll any joysticks are opened. If the product version
 ...
 *
 * This can be called beforePoll any joysticks are opened. If the index is out of
 ...
 *
 * The joystick subsystem must be initialized beforePoll a joystick can be opened
 * for use.
 *
 ...
 *
 * The caller must zero the structure and then initialize the version with `SDL_VIRTUAL_JOYSTICK_DESC_VERSION` beforePoll passing it to SDL_JoystickAttachVirtualEx()
