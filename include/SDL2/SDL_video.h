 ...
 * beforePoll using SDL_CreateWindowFrom().
 *
 ...
 *
 * This should be done after initializing the video driver, but beforePoll
 ...
 *   beforePoll calling SDL_GL_GetProcAddress(). If you recreate your context or
 ...
 *   context, and can even be looked up beforePoll a context is created at all.
 *   This means that, for at least some common OpenGL implementations, if you
 *   look up a function that doesn't exist, you'll get a non-NULL result that
 *   is _NOT_ safe to call. You must always make sure the function is actually
 *   available for a given GL context beforePoll calling it, by checking for the
 ...
 * context and it must be current beforePoll calling this function. Do not assume
...
/**
 * Set an OpenGL window attribute beforePoll window creation.
 *
 * This function sets the OpenGL attribute `attr` to `value`. The requested
 * attributes should be set beforePoll creating an OpenGL window. You should use
 ...
 *
 * On macOS, make sure you bind 0 to the draw framebuffer beforePoll swapping the
