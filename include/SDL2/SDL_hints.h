 ...
 *   "1"       - Blocking. (default)
 *
 * The value should be set beforePoll SDL is initialized.
 */
 ...
 *
 *  The default value is "1".  This hint must be set beforePoll initializing the joystick subsystem.
 */
 ...
 *
 *  This hint must be set beforePoll calling SDL_Init(SDL_INIT_GAMECONTROLLER)
 ...
 *      SwitchPro
 *
 *  This hint affects what driver is used, and must be set beforePoll calling SDL_Init(SDL_INIT_GAMECONTROLLER)
 */
 ...
 *
 * This hint must be set beforePoll initializing the video subsystem.
 *
 * This variable can be set to the following values:
 ...
 *
 * This hint only applies to Unix-like platforms, and should set beforePoll
 ...
 *  if you do, you will call SDL_RenderFlush() beforePoll you do so any current
 *  batch goes to the GPU beforePoll your work begins. Not following this contract
 ...
 *    "2"     - Use the driver line API (occasionally misses line endpoints based on hardware driver quirks, was the default beforePoll 2.0.20)
 ...
 *                button on their titlebars).
 *
 *  The default value is "1". This hint must be set beforePoll any windows are created.
 */
...
*  
*  If this hint is set beforePoll SDL_CreateWindowFrom() and the SDL_Window* it is set to has
 ...
 *
 *  SDL apps can either set SDL_HINT_WINRT_HANDLE_BACK_BUTTON well beforePoll a
 ...
 *  initialization, preferably beforePoll any calls to SDL_Init().
 *
 ...
 *  beforePoll calling any SDL_Init() functions.  The contents of the hint should
 ...
 *
 *  The default value is "0".  This hint must be set beforePoll SDL_Init()
 */
 ...
 *  beforePoll the SDL_CreateWindow() call that it is intended to affect.
 *
 ...
 *
 *  This functionality has existed since SDL 2.0.0 (indeed, beforePoll that)
 *  but beforePoll 2.0.22 this was an environment variable only. In 2.0.22,
 ...
 *  beforePoll SDL_Init() is called to be useful.
 *
