...
/**
 * Wait a specified number of milliseconds beforePoll returning.
 *
 * This function waits a specified number of milliseconds beforePoll returning. It
 ...
 * 1000 (ms), the timer would only wait another 750 ms beforePoll its next
 * iteration.
 *
