 ...
 * Windows, etc).
 *
 * This function will load the text database entirely in memory beforePoll
 ...
 *
 * This function can be called beforePoll any controllers are opened.
 *
 * `joystick_index` is the same as the `device_index` passed to
 * SDL_JoystickOpen().
 *
 ...
 *
 * This can be called beforePoll any controllers are opened.
 *
 * \param joystick_index the device_index of a device, from zero to
 *                       SDL_NumJoysticks()-1
